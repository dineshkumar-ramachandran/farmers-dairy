    ...
    <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-slide-up">
          <h1 className="text-4xl font-bold text-earth-900 mb-8">Privacy Policy</h1>
          ...
          <div className="card space-y-6">
            <section>
              ...
              <p className="text-earth-600 leading-relaxed">
                Farmer's Dairy ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Information We Collect</h2>
              ...
              <ul className="list-disc list-inside text-earth-600 space-y-2">
                ...
                <li>Subscribe to our delivery services</li>
                <li>Contact us for customer support</li>
                <li>Sign up for newsletters or promotional communications</li>
                <li>Participate in surveys or feedback forms</li>
              </ul>

              <h3 className="text-lg font-semibold text-earth-900 mt-6 mb-3">Types of Information Collected:</h3>
              <ul className="list-disc list-inside text-earth-600 space-y-2">
                <li>
                ...
                <li>
                  <strong>Delivery Information:</strong> Delivery preferences, special instructions
                </li>
                <li>
                  <strong>Usage Information:</strong> Website interaction data, preferences, order history
                </li>
              </ul>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">How We Use Your Information</h2>
              <p className="text-earth-600 leading-relaxed mb-4">We use the information we collect to:</p>
              <ul className="list-disc list-inside text-earth-600 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Information Sharing and Disclosure</h2>
              <p className="text-earth-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Data Security</h2>
              <p className="text-earth-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Your Rights and Choices</h2>
              <p className="text-earth-600 leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Cookies and Tracking Technologies</h2>
              <p className="text-earth-600 leading-relaxed mb-4">We use cookies and similar technologies to:</p>
              <ul className="list-disc list-inside text-earth-600 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Data Retention</h2>
              <p className="text-earth-600 leading-relaxed">
                We retain your personal information for as long as necessary to fulfill the purposes outlined in this
                policy, comply with legal obligations, resolve disputes, and enforce our agreements. When information is
                no longer needed, we securely delete or anonymize it.
              </p>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Children's Privacy</h2>
              <p className="text-earth-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Changes to This Privacy Policy</h2>
              <p className="text-earth-600 leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-earth-900 mb-4">Contact Us</h2>
              <p className="text-earth-600 leading-relaxed">
                If you have any questions about this Privacy Policy or our data practices, please contact us:
              </p>
              <div className="mt-4 p-4 bg-green-50 rounded-lg">
                <p className="text-earth-700">
                  <strong>Farmer's Dairy</strong>
                  <br />
