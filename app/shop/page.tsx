...
export default function ShopPage() {
  ...
  const handleAddToCart = (product: any) => {
    ...
    const cartItem = {
      ...
      dateRange,
      sampleSize,
      totalDays: subscription === "custom" ? calculateTotalDays(dateRange) : calculateSubscriptionDays(subscription),
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            ...
                            onSelect={(range) => setDateRanges((prev) => ({ ...prev, [product.id]: range }))}
                            numberOfMonths={2}
                      ...
                      <Popover>
                        ...
                        <PopoverContent className="w-auto p-0" align="start">
                          <Calendar
                            ...
                            onSelect={(date) => setDeliveryDates((prev) => ({ ...prev, [product.id]: date }))}
                            disabled={(date) => date < today}
                            initialFocus
                            classNames={{
                              head_cell: "text-center font-normal text-sm w-9",
