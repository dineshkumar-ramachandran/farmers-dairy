    ...
    <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-slide-up">
          <h1 className="text-4xl font-bold text-ink mb-8">Terms and Conditions</h1>
          ...
          <div className="card space-y-6">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">2. Acceptance of Terms</h2>
              <p className="text-ink-soft leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">4. Subscription Services</h2>
              <p className="text-ink-soft leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">5. Payment Terms</h2>
              <p className="text-ink-soft leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">6. Delivery Policy</h2>
              <p className="text-ink-soft leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">7. Quality Guarantee</h2>
              <p className="text-ink-soft leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">9. Changes to Terms</h2>
              <p className="text-ink-soft leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">10. Contact Information</h2>
              <p className="text-ink-soft leading-relaxed">
