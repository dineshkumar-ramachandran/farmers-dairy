...
import { ArrowRight, Truck, Shield, Clock, Heart, Star, Quote } from "lucide-react"
    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-text mb-4 animate-slide-up">Our Fresh Products</h2>
            <p className="text-lg text-text max-w-2xl mx-auto animate-fade-in">
              Choose from our selection of farm-fresh milk products delivered straight to your doorstep.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {featuredProducts.map((product, index) => (
              ...
              >
                ...
                <p className="text-text opacity-80 mb-4">{product.description}</p>
                <div className="text-2xl font-bold text-green mb-4">₹{product.price}</div>
      ...
      <section className="py-16 bg-mint-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl font-bold text-text mb-6 animate-slide-up">A LITTLE STORY ABOUT US</h2>
          <h3 className="text-2xl font-semibold text-green mb-8 animate-slide-up">Farmers Dairy</h3>
          <p className="text-lg text-text leading-relaxed animate-fade-in">
            ...
            based company in Hosur. Farmer's Dairy is a company that acts as a direct intermediate between a farmer and
            a consumer to provide fresh raw cow milk without adding any water or other preservatives. Farmer's Dairy is
            a small initiative that helps in benefiting both farmer's and the consumer with good price and good health.
            In this busy running world we deliver milk through eco friendly glass bottles to your doorstep.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-text mb-4">Why Choose Our Farm Fresh Milk?</h2>
            <p className="text-lg text-text max-w-2xl mx-auto">
              We're committed to delivering the purest, most nutritious milk from our family farm to your family table.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="card text-center animate-slide-up">
              ...
              <h3 className="text-xl font-semibold text-text mb-2">Daily Delivery</h3>
              <p className="text-text opacity-80">Fresh milk delivered to your doorstep every morning before 7 AM.</p>
            </div>
            ...
            <div className="card text-center animate-slide-up" style={{ animationDelay: "0.1s" }}>
              ...
              <h3 className="text-xl font-semibold text-text mb-2">100% Pure</h3>
              <p className="text-text opacity-80">No additives, no preservatives. Just pure, natural farm milk.</p>
            </div>
            ...
            <div className="card text-center animate-slide-up" style={{ animationDelay: "0.2s" }}>
              ...
              <h3 className="text-xl font-semibold text-text mb-2">Always Fresh</h3>
              <p className="text-text opacity-80">
                Milked in the morning, delivered the same day for maximum freshness.
              </p>
            </div>
            ...
            <div className="card text-center animate-slide-up" style={{ animationDelay: "0.3s" }}>
              ...
              <h3 className="text-xl font-semibold text-text mb-2">Family Farm</h3>
              <p className="text-text opacity-80">
            ...
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div className="text-center">
                  ...
                  <p className="text-sm text-text opacity-70">{testimonial.location}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold text-text mb-4">Ready to Experience Farm Fresh Milk?</h2>
          <p className="text-lg text-text mb-8">
            Join thousands of families who trust us for their daily milk needs. Start your subscription today and taste
            the difference.
          </p>
          <Link href="/shop" className="btn-primary inline-flex items-center">
            Browse Products
