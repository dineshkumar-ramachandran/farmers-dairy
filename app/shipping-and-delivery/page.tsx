    ...
    <div className="min-h-screen py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="animate-slide-up">
          <h1 className="text-4xl font-bold text-ink mb-8">Shipping and Delivery</h1>

          <div className="card space-y-6">
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Delivery Areas</h2>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Delivery Schedule</h2>
              <div className="bg-mint-light p-6 rounded-lg mb-4">
                <h3 className="text-lg font-semibold text-ink mb-2">Standard Delivery Hours</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Delivery Process</h2>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-mint-light rounded-lg">
                  ...
                  <h4 className="font-semibold text-ink mb-2">Morning Milking</h4>
                  <p className="text-sm text-ink-soft">Fresh milk collection from our farm</p>
                </div>
                <div className="text-center p-4 bg-mint-light rounded-lg">
                  <div className="text-2xl font-bold text-green-600 mb-2">6:30 AM</div>
                  <h4 className="font-semibold text-ink mb-2">Processing</h4>
                  <p className="text-sm text-ink-soft">Quality testing and bottling in glass containers</p>
                </div>
                <div className="text-center p-4 bg-mint-light rounded-lg">
                  <div className="text-2xl font-bold text-green-600 mb-2">7:00 AM</div>
                  <h4 className="font-semibold text-ink mb-2">Delivery</h4>
                  <p className="text-sm text-ink-soft">Fresh milk delivered to your doorstep</p>
                </div>
              </div>
            </section>

            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Delivery Instructions</h2>
              <ul className="list-disc list-inside text-ink-soft space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Subscription Delivery</h2>
              <p className="text-ink-soft leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Missed Deliveries</h2>
              <p className="text-ink-soft leading-relaxed mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Weather and Emergency Delays</h2>
              <p className="text-ink-soft leading-relaxed">
            ...
            <section>
              <h2 className="text-2xl font-semibold text-ink mb-4">Contact for Delivery Issues</h2>
              <p className="text-ink-soft leading-relaxed">
