        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-2 text-sm">
            <div className="flex items-center text-text hover:text-green transition-colors duration-300 animate-slide-left">
              ...
              <span className="bg-green text-white px-2 py-1 rounded font-semibold">9363778989</span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between py-4">
                ...
                {navItems.map((item, index) => (
                  <Link
                    ...
                    className={`text-sm font-medium transition-all duration-300 hover:scale-105 animate-fade-in ${
                      pathname === item.href ? "text-text border-b-2 border-green pb-1" : "text-text hover:text-green"
                    }`}
            ...
            <div className="md:hidden">
              <button onClick={toggleMobileMenu} className="text-text hover:text-green transition-colors duration-300">
